...
import { Container, Row, Col, Card, Tabs, Tab, Navbar } from "react-bootstrap";
          ...
          <Row>
            <Col>
              <div className="video-border">
                <ReactPlayer url={video} controls width="65%" height="65%" />
              </div>
            </Col>
          </Row>
          <Row>
            <Col>
              <Card className="mb-4">
                <Card.Body>
                  <Card.Text>
                    Welcome to our web community, a collaborative endeavor born
                    from the shared passion and dedication of five individuals
                    with a common goal - to empower and inspire technical minds.
                    We firmly believe in the power of knowledge, the value of
                    sharing, and the limitless potential of the next generation
                    of tech enthusiasts.
                  </Card.Text>
                </Card.Body>
              </Card>
          ...
          <Row>
            <Col>
              <Tabs id="justify-tab-example" className="mb-3" justify>
                ...
                <Tab eventKey="What We Offer" title="What We Offer">
                  <Card className="mb-3">
                    <Card.Body>
